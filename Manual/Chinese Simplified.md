...
如果是 ISO 镜像文件，请先挂载镜像文件，再使用 Office Tool 定位位置。PS：我们不推荐使用 ISO 镜像搭配 Office Tool 进行安装；直接在程序中下载安装文件和下载 ISO 文件是一样的安装包，而且程序下载的始终都是最新版本。
...
安装语言默认匹配系统语言 (Office Tool Lite 不支持匹配 MSI 版本的 Office 的语言)
